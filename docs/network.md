...
```yaml
# Paths to vmnet executables. Because socket_vmnet is invoked via sudo it should be
...
# socketVMNet requires Lima >= 0.12
  ...
  socketVMNetClient: /opt/socket_vmnet/bin/socket_vmnet_client
# DEPRECATED: vdeSwitch: /opt/vde/bin/vde_switch
# DEPRECATED: vdeVMNet: /opt/vde/bin/vde_vmnet
