...
type LimaYAML struct {
	...
	AdditionalDisks       []Disk        `yaml:"additionalDisks,omitempty" json:"additionalDisks,omitempty" jsonschema:"nullable"` // null array in default
	Mounts                []Mount       `yaml:"mounts,omitempty" json:"mounts,omitempty"`
	MountType             *MountType    `yaml:"mountType,omitempty" json:"mountType,omitempty" jsonschema:"nullable"`
	MountTypesUnsupported []string      `yaml:"mountTypesUnsupported,omitempty" json:"mountTypesUnsupported,omitempty" jsonschema:"nullable"` // null array in default
	...
	Networks              []Network     `yaml:"networks,omitempty" json:"networks,omitempty" jsonschema:"nullable"` // null array in default
...
type CACertificates struct {
	...
	Files          []string `yaml:"files,omitempty" json:"files,omitempty" jsonschema:"nullable"`                   // null array in default
	Certs          []string `yaml:"certs,omitempty" json:"certs,omitempty" jsonschema:"nullable"`                   // null array in default
}
