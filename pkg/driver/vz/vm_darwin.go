...
func createVM(inst *limatype.Instance) (*vz.VirtualMachine, error) {
...
func attachNetwork(inst *limatype.Instance, vmConfig *vz.VirtualMachineConfiguration) error {
...
func attachDisks(inst *limatype.Instance, vmConfig *vz.VirtualMachineConfiguration) error {
