...
// SPDX-FileCopyrightText: Copyright The gvisor-tap-vsock Authors
// SPDX-FileCopyrightText: Copyright 2017 Google Inc.

// Copied from https://github.com/containers/gvisor-tap-vsock/blob/v0.8.6/pkg/tcpproxy/tcpproxy.go
