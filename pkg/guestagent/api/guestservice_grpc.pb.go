...
type GuestServiceClient interface {
	...
	GetEvents(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (GuestService_GetEventsClient, error)
...
func (c *guestServiceClient) GetInfo(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Info, error) {
	out := new(Info)
...
func (c *guestServiceClient) GetEvents(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (GuestService_GetEventsClient, error) {
...
func (x *guestServicePostInotifyClient) CloseAndRecv() (*empty.Empty, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(empty.Empty)
...
type GuestServiceServer interface {
	...
	GetEvents(*empty.Empty, GuestService_GetEventsServer) error
...
func (UnimplementedGuestServiceServer) GetInfo(context.Context, *empty.Empty) (*Info, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetInfo not implemented")
}
func (UnimplementedGuestServiceServer) GetEvents(*empty.Empty, GuestService_GetEventsServer) error {
...
func _GuestService_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GuestServiceServer).GetInfo(ctx, req.(*empty.Empty))
	}
...
func (x *guestServicePostInotifyServer) SendAndClose(m *empty.Empty) error {
	return x.ServerStream.SendMsg(m)
}
