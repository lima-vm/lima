...
# Port forwarding configuration for the BATS port-forwarding test.
# Sourced by port-forwarding.bats and helpers/limactl.bash (for instance creation).
...
# The actual test code is in test-templates.sh in the "container-engine" block.
- guestIPMustBeZero: true
  guestPort: 8888
  hostIP: 0.0.0.0
